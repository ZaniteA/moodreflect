...
import datetime
import os
from PyQt6.QtWidgets import QVBoxLayout, QHBoxLayout, QWidget, QLabel, QTextEdit, QMessageBox
...
class NewMoodPage(QWidget):
    ...
    def save_recording(self,
                       filename: str = utilities.adjust_path(os.path.join(configs.DATA_DIR, configs.TEMP_AUDIO_FILE))) -> bool:
    ...
    def predict_mood(self):
        ...
        audio_file_path = (utilities.adjust_path(os.path.join(configs.DATA_DIR, configs.TEMP_AUDIO_FILE))
        ...
        os.remove(utilities.adjust_path(os.path.join(configs.DATA_DIR, configs.TEMP_AUDIO_FILE)))
    ...
    def save_mood(self):
        ...
        filename = utilities.adjust_path(os.path.join(configs.DATA_DIR, f'recording_{timestamp}.wav'))
