from PyQt6.QtWidgets import (QMainWindow, QWidget, QHBoxLayout, QListWidget, QListWidgetItem,
...
class MoodReflectApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Fonts
        self.heading_font_object = self.importFont('./assets/fonts/Manrope-Regular.ttf')
        self.body_font_object = self.importFont('./assets/fonts/SourceSans3-Regular.ttf')
        self.bold_body_font_object = self.importFont('./assets/fonts/SourceSans3-Bold.ttf')
